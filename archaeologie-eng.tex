...
With this option you can change it to a different outcome (but still according to the rules of the German Archaeological Institute) so the first citation will be a full citation and all the following citations will refer to the first full citation cf. \cref{seenote}
 ...
 With this bibliography one can cite journals and series according to the abbreviations of the German Archaeological Institute cf. \cref{strings}. 
...
If the bibliography entry is set with  |option={antik}| this behaviour is default cf. \cref{translation}. 
...
Bibliography entries with |option={antik}| or |option={frgantik}| (\cref{antik,frgantik}) are not touched by this option.
...
\end{description}
 ...
 \begin{description}
 \item[antik] 
 The entry is an ancient source (e.\,g. Cicero, Plutarch, etc) cf. \cref{antik}.

 \item[frgantik] 
 The entry is a fragmented ancient source (e.\,g. Festus) cf. \cref{frgantik}.
