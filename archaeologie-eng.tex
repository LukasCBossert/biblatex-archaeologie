...
\begin{itemize}
\item Hinzufügen des Bibliographieeintrags |@talk| (\cref{talk})
\item Hinzufügen einer extra Bibliographie für antike Autoren und Werke (\cref{ancient-list,ancient})
\end{itemize}
