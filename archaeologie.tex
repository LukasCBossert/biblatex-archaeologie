...
\date{Version: \archaeologieversion{} (\archaeologiedate)} 
 \maketitle
 \begin{abstract}
\noindent This citation-style covers the citation and bibliography rules of the German Archaeological Institute (\textbf{Deutsches Archäologisches Institute}). 
...
Download the folder |archaeologie| with all relevant files from the CTAN-server\footnote{\url{ctan.biblatex-archaeologie.de}} and copy the content of the |zip|-file to the \texttt{\$LOCALTEXMF} directory of
...
\end{example}
This is the equivalent to |\footnote{\cite{Osland2016}.}| but it saves you a lot of typing time.
 \DescribeMacro{\footcites} And as well \cs{footcites}.
\begin{example}
...
|\footnote{\cite{Ball2013}.}|
\tcblower
\footnote[2]{Ball – Dobbins loc. cit. (see n. \oarg{number of the footnote with full citation}) 470.}
\end{tcolorbox}
...
\footnote{\cite{Nieddu1995}.}
 ...
 |\footnote{\cite{Nieddu1995}.}|
 \tcblower
\footnote{LTUR 2 (1995) 9-10 s. v. Dei Consentes (G. Nieddu).}
 \end{tcolorbox}
  \end{enumerate}
...
\begin{example}
\footnote{\cite[Vgl.][145--146]{Cosa1949}.}
\end{example}
