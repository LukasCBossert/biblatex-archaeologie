...
Da der Bibliographieeintrag wie folgt aussieht \\
|@Book{Apul_met,|\\
|	author ={Apuleius Madaurensis, Lucius},  |\\
|	origtitle = {metamorphoses }, |\\
|	shorthand = {Apul. met.}, |\\
...
wird in der Bibliographie daraus (sofern man es aufgelistet haben möchte):\\
  	|\printbibliography[keyword = ancient,|\\
  	|								|| title={Antike Autoren}]|
