...
Werke, bei denen |options={ancient}| oder |options={frgancient}| (also antike Autoren und Fragmente) gesetzt wurde, werden stehts mit Originaltitel, Sprache und Übersetzer angegeben.
