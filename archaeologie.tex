...
\usepackage[%				
		...
		inreferences=true,		%true = fullcite of inreferences in the footnotes
		]{biblatex}
\end{lstlisting}
...
\subsubsection{abbrv}\label{abbrv}
 \DescribeMacro{abbrv}
 If you want to use the above mentioned method with |@string| you have to activate the option called  |abbrv| in the preamble.
...
With the option |ancient| you load an additional bibliography called |bibliography-ancient.bib| in which we inserted almost 600 entries of ancient authors and works with their abbreviation according to The New Pauly/Thesaurus Linguae Latinae.
For the complete list of those see  \cref{ancient-list}.

You can cite the authors with the bold abbreviation in the second line. 
The authors and works are separated by a colon.
Let me make it clear with the example:

\begin{refsection}
With the loaded option |ancient| you write this 
|\cite[3,2,5--7]{Apul:met}|  and will get in return after compiling  give: \cite[3,2,5--7]{Apul:met}.
\end{refsection}
