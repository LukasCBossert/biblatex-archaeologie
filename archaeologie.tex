...
\MakeShortVerb{\"}
 ...
 \title{\texttt{archaeologie} -- \texttt{biblatex} für Archäologen}
...
Es bietet sich jedoch an, mit (nummerierten) Unterbibliographien zu arbeiten:
\begin{bsp}
...
"}"\\[3pt]
 ...
 \item\label{book:c} Vgl. {\sc Riess}, Willhelm: Apuleius und die Räuber. Ein Beitrag zur historischen Kriminalforschung (HABES 31), Stuttgart 2001, 19.
 \item\label{book:d} {\sc Southern}, P.: Domitian (1997), 5. 
 \item\label{book:e} {\sc Riess}, W.: Apuleius und die Räuber (2001), 20.
 \end{enumerate}
