...
Second citation of
\begin{tcolorbox}[examplebox] 
\cs{footnote}\{\cs{cite}{[}470{]}\{Ball2013\}.\}
\tcblower
Ball – Dobbins loc. cit. (see n. \oarg{number of the footnote with full citation}) 470.
\end{tcolorbox}
...
\begin{tcolorbox}[examplebox] 
... , this is also shown by R. M. Boehmer und  N. Wrede in their latest article \emph{Astragalspiele in und um Warka} (1985).
\end{tcolorbox}
\end{refsection}
...
\begin{example}
Just some text.\footnote{\cite[Vgl.][142--144]{Mann2011}.}
\end{example} 
...
\begin{bibbox}{Lexikon-der-Technik,Weinbrenner1914}
...
\begin{tcolorbox}[examplebox]
\cs{cite}[vgl.][930 Nr. 283]\{Neils1994\}. 
\tcblower
...
\begin{tcolorbox}[examplebox]
\cs{parencite}[vgl.][930 Nr. 283]\{Neils1994\}.
\tcblower
