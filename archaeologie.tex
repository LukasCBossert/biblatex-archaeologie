...
\DescribeMacro{\citetranslator*}\archversion{v.2.3.0}
\begin{code}
\citetranslator* *@\marg{bibtex-key}%@*
\end{code} 
...
\DescribeMacro{@MvBook}\archversion{v.2.3.4} If you have a small series consistend of several volumes and you want to have them listed together you should read the following.
...
\begin{manualexample}
\textbackslash footnote\{\textbackslash cite\{Neils1994\}.\}
\tcblower
