...
With the option |bibancient| you load an additional bibliography called |bibliography-ancient.bib| in which we inserted almost 600 ancient authors and works with their abbreviation according to The New Pauly/Thesaurus Linguae Latinae.
...
\lstlistoflistings
\end{multicols}
\section{Ancient authors and works}\label{list-bibancient}
...
\section{bibcorpora}\label{list-bibcorpora}
