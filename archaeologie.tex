...
In line 5 and 6 you can also write the full or abbrivated journal title in the fields |journaltitle| or |shorttitle| (e.g. |journaltitle = {British School of Athens}|, |shortjournal = {BSA}|), but we chose to use a |@string| (cf. \cref{ancient-list,string}) again.
...
\begin{description}
\item[jstor] If you can refer to the on-line plattform \href{www.jstor.org}{jstor} then you need the individual number for the article -- cf. \cref{jstor,jstor1}:
\begin{lstlisting}
...
All bibliographical entries in this OPAC can be referred to via thhis link.
...
\clearpage
\section{Ancient authors and works}\label{ancient-list}
