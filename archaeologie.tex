...
\vspace*{1em}\\
\noindent This citation-style covers the citation and bibliography rules of the German Archaeology Insitute. Various options are available to change and adjust the outcome according to one's own preferences.\footnote{The style is compatible with the English language, since all "bibstrings" used are defined bilingually.}
 \end{abstract}
 \vspace*{1em}
\begin{small}
\begin{multicols}{2}
