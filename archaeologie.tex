...
\noindent This citation-style takes care of the citation and bibliography rules made by the German Archaeology Insitute.
...
"@Book{Boehm_2001,"\\
 ...
 " Titleaddon = {Festschrift für Jörg Schäfer"\\ "zum 75. Geburtstag am 25. April 2001},"\\
...
"@Incollection{Hoelscher_2001,"\\
 ...
 " Editor  = {Böhm, Stephanie and Eickstedt, Klaus-Valtin von},"\\
 " Maintitle = {Ithake},"\\
 " Maintitleaddon = {Festschrift für Jörg Schäfer"\\ "zum 75. Geburtstag am 25. April 2001},"\\
 " Publisher = {Ergon-Verlag},"\\
  "Year    = {2001},"\\
 " Location = {Würzburg},"\\
"}"\par
...
Da manche Kürzel von Zeitschriften oder Reihen nicht als @string übernommen werden konnten, musste die Liste an die \TeX-verarbeitende Lesart angepasst werden.
...
Es empfiehlt sich, in diesen Listen die @string-Angaben nachzuschauen und dann für "journaltitle" und "shortjournal", bzw. "series" und "shortseries" einzutragen: Es wird immer der gleiche "@string" aus der unten aufgeführten Liste in "journaltitle" und "shorttitle" eingetragen.
Die Unterscheidung, ob in der Bibliographie die Abkürzung (Standard) oder der voller Titel genannt werden soll, erfolgt automatisch über die Option "keineabkuerzung" (Siehe \cref{keineabkuerzung}).
...
\subsection{archaeologie.cbx}
 ...
 \changes{v0.9}{2015/07/07}{First public version}
\PrintChanges
\PrintIndex
