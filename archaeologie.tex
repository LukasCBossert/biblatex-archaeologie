...
\DescribeMacro{lstlocations}
 This activates the additional bibliography file  |archaeologie-lstlocations.bib|
 with |@strings| which can be used for locations to print out their correct exonym in the selected language cf. \cref{lstlocations}.

\DescribeMacro{lstpublishers}
This activates the additional bibliography file  |archaeologie-lstpublishers.bib| with |@strings| which can be used for publishers to print out their correct name cf. \cref{lstpublishers}.
