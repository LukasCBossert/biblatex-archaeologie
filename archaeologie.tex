...
The original book is from \citeauthor*{Zanker_2014} and has been published in \citeyear{Zanker_2014}.
\begin{lstlisting}
@Book{Zanker_2014,
  author    = {Zanker, Paul},
...
\end{lstlisting}
But before it got translated in \citeyear{Zanker_2013}:
\begin{lstlisting}
@Book{Zanker_2013,
  author      = {Zanker, Paul},
...
The translated book |Zanker_2013| is connected with the book |Zanker_2014| via the field |related = |\marg{bibtex-key} and the relation got specified with the field |relatedtype|, in this case it is a translation so |={translationof}|.

You don’t have to cite |Zanker_2014| to have the information visible in the bibliography. 
It will be included automatically. For the following bibliography we only use |\cite{Zanker_2013}|:
