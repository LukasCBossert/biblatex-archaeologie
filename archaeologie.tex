...
\end{bibbsp}
The advantage lies in the possibility to create a separate bibliography with all the abbreviations of used journal titles and series (see  \cref{bibliographie}).
...
Such a |@String| can be used in your entire bibliography. 
You only need to add the |@String| information in the beginning of your |bib|-file.
\begin{lstlisting}
@String { *@\meta{abbreviation}@* = { *@\meta{long form}@* } }
\end{lstlisting}
Now you can add everywhere the \meta{abbreviation} and in the end it will use the \meta{long form}.
