...
\item[publisher]   Angabe aller Verlagsorte und Verlag selbst. Ändert die Formatierung der Edition und Erstausgabe.  
...
\item[counter] Angabe über die Anzahl an Zitationen des Werks im Text. 
\end{description}
