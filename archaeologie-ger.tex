...
Um die externen Bibliographien, die |archaeologie| optional bereitstellt, korrekt einzubinden, ist ein Schrift-Encoding von Nöten, das auch griechische Schriftzeichen enthält. Für \LaTeX{} ist ein Unicode-Encoding z.\,B. über \cs{inputenc{utf8}} eine mögliche Lösung. \XeLaTeX{} unterstützt Unicode von Hause aus.
...
\cs{parencite} und \cs{parencites} verhalten sich analog zu \cs{cite} und \cs{cites}.
...
\cs{textcite} und \cs{textcites} verhalten sich analog zu \cs{cite} und \cs{cites}.
